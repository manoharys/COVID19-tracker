...
//Dom elements
const changeCountry_element = document.querySelector('.change-country');
const searchCountry_element = document.querySelector('.search-country');
const input = document.querySelector('#search-input');
const countryList_element = document.querySelector('.country-list');
...
function createCountryList() {
    ...
    country_list.forEach((country, index) => {
        if (index % Math.ceil(numCountries / num_of_ul_lists) == 0) {
            ul_list_id = `list-${i}`;
